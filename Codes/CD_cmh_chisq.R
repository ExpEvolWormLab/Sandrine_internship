...
for(i in 1:ncol(D100)){
  p.values_chisq_100 <- cbind(chi.sq.test(A0=D0, a0=d0, At=D100[,i] ,at=d100[,i],min.cov=20, max.cov=0.99, min.cnt=1, log=TRUE))
}
...
grid.arrange(p_chisq_32+coord_cartesian(ylim = c(0, M)),p_chisq_35+coord_cartesian(ylim = c(0, M)), ncol = 2)
